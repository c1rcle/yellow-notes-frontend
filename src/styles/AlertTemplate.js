...
var AlertTemplate = function AlertTemplate(_ref) {
  ...
  let currentStyle = alertStyle;
  if (options.type === 'error') currentStyle = errorStyle;
  if (options.type === 'info') currentStyle = infoStyle;

  return React.createElement(
    'div',
    { style: _extends({}, currentStyle, style) },
    ...
    React.createElement(
      'button',
      { onClick: close, style: buttonStyle, id: 'alert-button' },
